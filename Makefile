...
bximage: misc/bximage.o misc/hdimage.o misc/vmware3.o misc/vmware4.o misc/vpc-img.o misc/vbox.o
	$(CXX) -o $@ $(CXXFLAGS_CONSOLE) $(LDFLAGS) $(BXIMAGE_LINK_OPTS) misc/bximage.o misc/hdimage.o misc/vmware3.o misc/vmware4.o misc/vpc-img.o misc/vbox.o

niclist: misc/niclist.o
	$(CXX) -o $@ $(CXXFLAGS_CONSOLE) $(LDFLAGS) misc/niclist.o

bxhub: misc/bxhub.o misc/netutil.o
	$(CXX) -o $@ $(CXXFLAGS_CONSOLE) $(LDFLAGS) misc/bxhub.o misc/netutil.o -lws2_32
...
misc/netutil.o: $(srcdir)/iodev/network/netutil.cc $(srcdir)/iodev/network/netutil.h \
  $(srcdir)/iodev/network/netmod.h $(srcdir)/misc/bxcompat.h
	$(CXX) -c $(BX_INCDIRS) -DBXHUB $(CXXFLAGS_CONSOLE) $(srcdir)/iodev/network/netutil.cc -o $@
